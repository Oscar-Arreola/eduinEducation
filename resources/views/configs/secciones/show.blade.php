				...
				<div class="col-12 col-md-6 py-3">
					<div class="card h-100">
						<form action="{{route('config.seccion.update',$elem->id)}}" class="card-body" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<input type="file" id="imagen" name="imagen" class="dropify"  data-weight="7em" @if ($elem->imagen) data-default-file="{{ asset("/img/photos/seccions/".$elem->imagen)}}" @endif required />
								<div class="text-center">
									@switch($elem->seccion)
										@case(4)

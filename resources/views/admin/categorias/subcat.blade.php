								...
								<td>
									<div class="text-right">
										<div class="btn-group btn-group-sm" role="group">
											...
											<button type="button" class="btn btn-sm btn-danger m-0 @if ($cat->prods) disabled @endif" data-toggle="modal" data-target="#frameModalDel" data-id="{{$cat->id}}"><i class="fas fa-trash-alt"></i></button>
										</div>
									</div>
								</td>
							</tr>

		...
		<div class="card">
			<div class="card-body">
				<div class="table-responsive">
					<table id="pedidos" class="table table-striped table-hover table-sm">
						<thead>
								...
								@foreach ($pedidos as $pedido)
									<tr>
										...
										<td class="text-center">
											...
											<button data-id="{{$pedido->id}}" data-estatus="{{$pedido->estatus}}" class="changestatus btn btn-{{$pedido->estatusClase}} btn-sm" type="button" >
												{{$pedido->estatusTxt}}
											</button>
